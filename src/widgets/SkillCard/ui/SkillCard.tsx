...
import type { SkillCardProps, SkillProps } from '@/widgets/SkillCard/ui/types';
    ...
    <div className={styles.card}>
      ...
      <div className={styles.skills}>
        ...
        <div className={styles.tags}>
          ...
          <div className={styles.tagList}>
            {skillsToLearn.slice(0, 2).map((item: SkillProps) => (
              <Tag key={item.id} category={item.category}>
                {item.name}
              </Tag>
            ))}
